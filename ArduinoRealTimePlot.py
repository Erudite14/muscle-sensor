...
def animate(i, dataList, ser):
    ser.write(b'g')                                     # Transmit the char 'g' to receive the Arduino data point                 # open serial port
    ...
    ax.set_title("Muscle Sensor Data")                  # Set title of figure
...
ser = serial.Serial("/dev/ttyACM0", 115200)                       # Establish Serial object with COM port and BAUD rate to match Arduino Port/rate
